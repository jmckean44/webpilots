...
const AccordionDemo = () => (
	<Accordion.Root className="AccordionRoot" type="single" defaultValue="item-1" collapsible>
		...
		<Accordion.Item className="AccordionItem" value="item-2">
			...
			<AccordionContent>Yes. It's unstyled by default, giving you freedom over the look and feel. Yes. It's unstyled by default, giving you freedom over the look and feel.</AccordionContent>
		</Accordion.Item>
